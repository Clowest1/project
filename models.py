...
class FileLink(Base):
    ...
    link_uuid = Column(String, unique=True, index=True)  # Уникальный UUID ссылки
...
class File(Base):
    ...
    links = relationship("FileLink", back_populates="file") 
...
class FileVersion(Base):
    ...
    version = Column(Integer)  # Номер версии
    created_at = Column(DateTime, default=datetime.utcnow)
